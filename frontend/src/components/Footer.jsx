...
// Site-wide footer with navigation columns and social links
  ...
  return (
    <footer className="bg-navy-950 text-gray-400 mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <Link to="/" className="text-2xl font-extrabold text-white tracking-tight">
            Cloud<span className="text-navy-400">Mart</span>
          </Link>
          <p className="mt-3 text-sm leading-relaxed">
            Your go-to store for quality products at fair prices. Built as a DevOps practice project.
          </p>
          {/* Social icons */}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/" className="hover:text-white transition">Footwear</Link></li>
            <li><Link to="/" className="hover:text-white transition">Bags</Link></li>
            <li><Link to="/" className="hover:text-white transition">Sports</Link></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-800 py-4 text-center text-xs text-gray-600">
        © {year} CloudMart. All rights reserved. — Built as a DEPI DevOps Practice Project.
      </div>
    </footer>
  );
}
